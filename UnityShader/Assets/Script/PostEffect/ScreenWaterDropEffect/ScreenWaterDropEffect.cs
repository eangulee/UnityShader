...
[ExecuteInEditMode]
[AddComponentMenu("PostEffect/ScreenWaterDropEffect")]
public class ScreenWaterDropEffect : MonoBehaviour 
{
    ...
    void Start()
    {
        ...
        //载入素材图
        ScreenWaterDropTex = Resources.Load("textures/ScreenWaterDrop") as Texture2D;

        //找到当前的Shader文件
        CurShader = Shader.Find("Custom/PostEffect/ScreenWaterDropEffect");
    }
