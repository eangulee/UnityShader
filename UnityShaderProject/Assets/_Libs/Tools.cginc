...
//value: [0, 1]
float2 Convert01(in float2 value)
{
	return float2(value.xy * 0.5 + 0.5);
}

//value: [0, 1]
float3 Convert01(in float3 value)
{
	return float3(value.xyz * 0.5 + 0.5);
}

//value: [0, 1]
float4 Convert01(in float4 value)
{
	return float4(value.xyzw * 0.5 + 0.5);
}
